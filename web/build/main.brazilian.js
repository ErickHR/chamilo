...
$(function() {
    ...
    $('#confirm-delete').on('show.bs.modal', function(e) {
        ...
        var message = 'Tem\u0020certeza\u0020que\u0020deseja\u0020deletar <strong>' + $(e.relatedTarget).data('item-title') + '</strong>';
    ...
    $.datepicker.regional["local"] = $.datepicker.regional["pt"];
    ...
    $(".chzn-select").chosen({
        ...
        placeholder_text_single: 'Por\u0020favor,\u0020selecione\u0020uma\u0020op\u00E7\u00E3o',
        width: "100%"
    });
    ...
    $('.star-rating li a').on('click', function(event) {
        ...
        $('#vote_label2_' + id).html("Carregando");
        $.ajax({
            url: $(this).attr('data-link'),
            success: function(data) {
                $("#rating_wrapper_"+id).html(data);
                if (data == 'added') {
                    //$('#vote_label2_' + id).html("Salvo.");
                }
                if (data == 'updated') {
                    //$('#vote_label2_' + id).html("Salvo.");
                }
...
function action_click(element, table_id) {
    var d = $("#"+table_id);
    if (!confirm('Por\u0020favor\u0020confirme\u0020a\u0020sua\u0020escolha')) {
        return false;
    } else {
